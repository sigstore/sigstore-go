...
type BundleForRekorV2 struct { //nolint:revive
	Bundle
}
...
func NewBundleForRekorV2(pbundle *protobundle.Bundle) (*BundleForRekorV2, error) { //nolint:revive
	bundle := &BundleForRekorV2{Bundle{
		Bundle:              pbundle,
		hasInclusionPromise: false,
		hasInclusionProof:   false,
	}}
